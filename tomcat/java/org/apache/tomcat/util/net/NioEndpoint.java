...
public class NioEndpoint extends AbstractJsseEndpoint<NioChannel, SocketChannel> {
    ...
    public void startInternal() throws Exception {
        if (!running) {
            ...
            // Create worker collection  创建工作者线程池
            if (getExecutor() == null) {
                createExecutor();
            }
    ...
    public class Poller implements Runnable {
         ...
         * poller for triggered events and hands the associated socket off to an appropriate processor as events occur.
         */
        @Override
        public void run() {
            ...
            while (true) {
                ...
                // Walk through the collection of ready keys and dispatch any active event. 对已经准备好的 key 进行处理
                ...
                if (close) {
                    ...
                    if (sk.isReadable() || sk.isWritable()) {
                        if (socketWrapper.getSendfileData() != null) {
                            ...
                            // Read goes before write 1. 处理读事件，比如生成 Request 对象
                            if (sk.isReadable()) {
                            ...
                            // 2. 处理写事件，比如将生成的 Response 对象通过 socket 写回客户端
        ...
        protected void doRun() {
            ...
            try {
                ...
                if (handshake == 0) {
                    ...
                    // Process the request from this socket 将处理逻辑交给`Handler`处理，当event为null时，则表明是一个`OPEN_READ`事件
                    if (event == null) {
