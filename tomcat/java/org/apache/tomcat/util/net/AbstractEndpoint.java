...
/**
 * @param <S> The type used by the socket wrapper associated with this endpoint. May be the same as U.
 * @param <U> The type of the underlying socket used by this endpoint. May be the same as S.
 * @author Mladen Turk
...
public abstract class AbstractEndpoint<S, U> {
    ...
    public static interface Handler<S> {
         ...
         * @deprecated Unused, will be removed in Tomcat 10, replaced by AbstractEndpoint.getConnections
         */
        @Deprecated
     ...
     *                                  configuration has already been provided for that host
     */
     ...
     * should be used for server sockets. By default, this value is 100.
     */
     ...
     * <code>true</code>.
     *
     * @return <code>true</code> if the endpoint supports ALPN in its current configuration, otherwise <code>false</code>.
     */
    ...
    public void setMaxThreads(int maxThreads) {
        ...
        if (internalExecutor && executor instanceof java.util.concurrent.ThreadPoolExecutor) {
            // The internal executor should always be an instance of
            // j.u.c.ThreadPoolExecutor but it may be null if the endpoint is not running.
            // This check also avoids various threading issues.
     ...
     * processing as if the Poller (for those endpoints that have one) selected the socket.
     *
    ...
    private void registerJmx(SSLHostConfig sslHostConfig) {
        ...
        try {
            sslOname = new ObjectName(domain + ":type=SSLHostConfig,ThreadPool=\"" + getName() + "\",name=" + ObjectName.quote(sslHostConfig.getHostName()));
        ...
        for (SSLHostConfigCertificate sslHostConfigCert : sslHostConfig.getCertificates()) {
            ...
            try {
                ...
                getLog().warn(sm.getString("endpoint.invalidJmxNameSslHostCert", sslHostConfig.getHostName(), sslHostConfigCert.getType()), e);
            }
        }
    }
