...
/**
 * <p><strong>RuleSet</strong> for processing the contents of a Context definition element.</p>
 *
...
public class ContextRuleSet implements RuleSet {
    ...
    public void addRuleInstances(Digester digester) {
        ...
        // 为 Context 指定类加载器，默认为 org.apache.catalina.loader.WebappLoader,通过 className 属性可以指定自己的实现类。
        ...
        // 为 Context 添加会话管理器，默认实现为 StandardManager，同时为管理器指定会话存储方式和会话标识生成器。Context 提供了多种会话管理方式。
        ...
        // 为 Context 添加资源链接 ContextResourceLink，用于 J2EE 命名服务。
        ...
        digester.addSetNext(prefix + "Context/CookieProcessor",
                "setCookieProcessor", "org.apache.tomcat.util.http.CookieProcessor");
    }
}
