...
public final class Bootstrap {
    ...
    public void init() throws Exception {
        ...
        // 通过反射实例化 org.apache.catalina.startup.Catalina 类的实例
        ...
        // 调用了 Catalina 实例的 setParentClassLoader 方法设置了父 ClassLoader。
        method.invoke(startupInstance, paramValues);

        // 将 Catalina 实例赋值给 Bootstrap 实例的 catalinaDaemon
    ...
    private void load(String[] arguments) throws Exception {
        ...
        // 反射调用了 org.apache.catalina.startup.Catalina#load 方法
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            if (command.equals("startd")) {
                ...
                // 首先调用了 BootStrap 的 load 方法，然后调用了 start 方法
    ...
    protected static String[] getPaths(String value) {
        ...
        while (matcher.find()) {
            ...
            if (first == '"' && last == '"' && path.length() > 1) {
                ...
                // Unbalanced quotes
                // Too early to use standard i18n support. The class path hasn't been configured.
                throw new IllegalArgumentException(
                        "The double quote [\"] character only be used to quote paths. It must " + "not appear in a path. This loader path is not valid: [" + value + "]");
            } else {
                // Not quoted - NO-OP
            }
