...
public final class StandardServer extends LifecycleMBeanBase implements Server {
     ...
     * This keeps the main thread alive - the thread pool listening for http connections is daemon threads.
     */
    @Override
    public void await() {
    ...
    protected void initInternal() throws LifecycleException {
        ...
        // Register global String cache Note although the cache is global, if there are multiple Servers
        // present in the JVM (may happen when embedding) then the same cache will be registered under multiple names
