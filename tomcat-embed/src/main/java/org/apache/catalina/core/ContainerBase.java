...
public abstract class ContainerBase extends LifecycleMBeanBase implements Container {
     ...
     * @throws IllegalArgumentException if this exception is thrown by the <code>setParent()</code> method of the child Container
     * @throws IllegalArgumentException if the new child does not have a name unique from that of existing children of this Container
